...
Mink=Distance_metrics.Minkowski_Distance(X1=X1,X2=X2,p=3)#order will be as per user's choice
print("Minkowski Distance: ",Mink)

WMink=Distance_metrics.WMinkowski_Distance(X1=X1,X2=X2,p=3,w=0.5)#order and weight will be as per user's choice
print("Weighted Minkowski Distance: ",WMink)

V=np.random.randint(0,10,size=(len(X1),1))#Variance to be provided by user
...
#User can generate boolean data as per his/her requirement
