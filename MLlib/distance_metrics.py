...
class Distance_metrics:
    ...
    def Jaccard_Distance(self, X1, X2):
        ...
        for i in range(len(X1)):
            ...
            distance.append((result[2]+result[3]) /
    ...
    def Kulsinki_Distance(self, X1, X2):
        ...
        for i in range(len(X1)):
            result = self.__boolean_opr(X1[i], X2[i])
            distance.append(
                (result[2]+result[3]+result[0]-result[1])/(result[2]+result[3]+result[0]))
        return (distance)
    ...
    def Rogers_Tanimoto_Distance(self, X1, X2):
        ...
        for i in range(len(X1)):
            result = self.__boolean_opr(X1[i], X2[i])
            distance.append(2*(result[2]+result[3]) /
    ...
    def Sokal_Sneath_Distance(self, X1, X2):
        ...
        for i in range(len(X1)):
            result = self.__boolean_opr(X1[i], X2[i])
            distance.append((result[2]+result[3]) /
                            (0.5*result[1]+result[2]+result[3]))
        return (distance)
